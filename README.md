...
### Reason for creation: 
  ...
  > 1. Large community support for the project online.
  > 1. Product research and desgine 
...
Each life support subsystem that is created has a large number of settings to maintain its function. These settings can be changed via serial communication through the front end interface. 
